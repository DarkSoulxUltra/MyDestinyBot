...
from DestinyBot.modules import ALL_MODULES
from DestinyBot.modules.helper_funcs.chat_status import is_user_admin
from DestinyBot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("DestinyBot.modules." + module_name)
...
def unmei_about_callback(update, context):
    query = update.callback_query
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        unmei_about_callback, pattern=r"unmei_", run_async=True
    )
